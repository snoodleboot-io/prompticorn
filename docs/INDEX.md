...
**29 languages**, targeting Kilo, Cline, Claude, Cursor, Copilot, Roo Code, Junie, and Zed.
...
See `docs/builders/` for per-tool builder guides (Kilo, Cline, Claude, Cursor, Copilot, Roo Code, Junie, Zed)
