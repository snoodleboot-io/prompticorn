...
**29 languages**, targeting Kilo, Cline, Claude, Cursor, Copilot, Roo Code, and Junie.
...
See `docs/builders/` for per-tool builder guides (Kilo, Cline, Claude, Cursor, Copilot, Roo Code, Junie)
