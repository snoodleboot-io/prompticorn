...
**29 languages**, targeting Kilo, Cline, Claude, Cursor, Copilot, and Roo Code.
...
See `docs/builders/` for per-tool builder guides (Kilo, Cline, Claude, Cursor, Copilot, Roo Code)
