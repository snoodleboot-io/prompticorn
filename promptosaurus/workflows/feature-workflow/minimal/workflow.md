...
description: Step-by-step feature implementation process
steps:
- Before writing code
- After confirmation
...
- Propose approach with tradeoffs
- Flag assumptions
...
- List follow-up work (tech debt, missing tests, related changes)
- List tests that should be written or updated
