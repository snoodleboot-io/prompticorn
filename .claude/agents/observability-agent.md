...
| Distributed Tracing Instrumentation | User Request | .claude/skills/distributed-tracing-instrumentation/SKILL.md | When workflow requires distributed-tracing-instrumentation |
| Grafana Dashboard Design | **Level 1: Executive Dashboard** | .claude/skills/grafana-dashboard-design/SKILL.md | When workflow requires grafana-dashboard-design |
...
| Prometheus Query Patterns | rate(http_requests_total[5m]) | .claude/skills/prometheus-query-patterns/SKILL.md | When workflow requires prometheus-query-patterns |
| Slo Sli Definition | **SLO (Service Level Objective):** What we promise (99.9%) | .claude/skills/slo-sli-definition/SKILL.md | When workflow requires slo-sli-definition |
