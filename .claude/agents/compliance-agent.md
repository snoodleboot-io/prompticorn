...
|-------|---------|-----------|-------------|
| Compliance Automation | The annual compliance scramble exists because controls are tested once, by | .claude/skills/compliance-automation/SKILL.md | When workflow requires compliance-automation |
