...
2. ✅ **Loader Location**: `prompticorn/ir/loaders/agent_skill_mapping_loader.py`
3. ✅ **File Location**: `prompticorn/configurations/agent_skill_mapping.yaml` (NOT project root)
...
### New Files:
1. **`prompticorn/configurations/agent_skill_mapping.yaml`** - 25 agent entries
...
### Modified Files:
1. **`prompticorn/prompt_builder.py`** - Add agent_skill_loader, update filtering
2. **`prompticorn/ir/loaders/__init__.py`** - Export new loader
3. **`prompticorn/configurations/language_skill_mapping.yaml`** - Remove python section
4. **`README.md`** - Document the two-tier mapping system

## Implementation Order

### Phase 1: Create Infrastructure
1. Create `prompticorn/configurations/agent_skill_mapping.yaml`
