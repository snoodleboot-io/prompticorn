...
public API for the prompticorn UI system.
...
from prompticorn.ui.pipeline.state_update_stage import StateUpdateStage
from prompticorn.ui.ui_factory import UIFactory
...
def select_option_with_explain(
    ...
    This is the main entry point for interactive selection in prompticorn.
