"""Ruby source-tree layout style question (core, per-language)."""

from prompticorn.questions.base.question import Question


class RubyLayoutStyleQuestion(Question):
    """Ruby source-tree layout style (flat vs src) - core, per-language.
    ...
    def question_text(self) -> str:
        return "Which source-tree layout should the Ruby conventions document?"
