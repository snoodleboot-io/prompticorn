...
This directory contains reusable Jinja2 macro libraries for generating standardized documentation and guidance across the prompticorn project.
...
env = Environment(loader=FileSystemLoader('prompticorn/prompts'))
...
- All templates are designed to work with existing prompticorn config context
