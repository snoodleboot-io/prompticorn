...
from prompticorn.builders.template_handlers.coverage_handler import CoverageHandler
from prompticorn.builders.template_handlers.coverage_tool_handler import CoverageToolHandler
from prompticorn.builders.template_handlers.e2e_tool_handler import E2EToolHandler
...
from prompticorn.builders.template_handlers.mocking_library_handler import MockingLibraryHandler
from prompticorn.builders.template_handlers.mutation_tool_handler import MutationToolHandler
...
from prompticorn.builders.template_handlers.template_handler import (
    TemplateHandler,
    TemplateVariableHandler,
)
from prompticorn.builders.template_handlers.test_runner_handler import TestRunnerHandler
...
class Builder:
    ...
    def _create_jinja2_environment(self) -> jinja2.Environment:
        ...
        # Configure Jinja2 environment with sensible defaults for prompticorn
